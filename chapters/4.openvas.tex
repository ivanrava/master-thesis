...
\subsection{VT}
Gli scanner veri e propri e le applicazioni eseguite da questi ultimi sui sistemi bersaglio per trovare le vulnerabilità, ovvero i \textbf{Vulnerability Test (VT)}. Gli scanner inclusi in GVM sono ovviamente \textbf{OpenVAS} e lo ``scanner'' \textbf{Notus}, in realtà un componente Python che razionalizza e ottimizza la verifica degli script NASL\footnote. A partire dalla versione 23.0 di OpenVAS entrambi i componenti sono stati sostituiti da \texttt{openvasd}
