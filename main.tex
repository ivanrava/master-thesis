...
\titlecontents{chapter}[-4.5em]{\sffamily \bfseries \addvspace{5ex}}%
{\MakeUppercase CAP. {\huge \thecontentslabel} \quad \Large \MakeUppercase}%
{}%
...
\let\OldTexttt\texttt
\renewcommand{\texttt}[1]{\textcolor{green!40!teal}{\OldTexttt{#1}}}
